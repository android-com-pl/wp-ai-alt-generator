                    ...
                    '<p>'
                        . wp_kses(
                            sprintf(
                                ...
                                __(
                                    'This plugin uses WordPress AI Client to generate alternative text for images. AI providers and credentials are managed centrally under %1$sSettings → Connectors%2$s.',

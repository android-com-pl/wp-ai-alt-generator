...
Tags: alt text, accessibility, SEO, GPT-4, OpenAI, image
...
The plugin uses the OpenAI API, which may incur costs. Please check the [OpenAI pricing page](https://openai.com/pricing/) for details.
